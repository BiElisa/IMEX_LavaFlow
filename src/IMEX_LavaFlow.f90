!********************************************************************************
!> \mainpage IMEX_LavaFlow - Shallow Water Finite volume solver
!> IMEX_LavaFlow is a FORTRAN90 code designed to solve an hyperbolic 
